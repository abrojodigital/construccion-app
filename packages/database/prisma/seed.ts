...
async function main() {
  ...
  await prisma.expense.createMany({
    data: [
      ...
      { reference: 'GAS-2024-00005', description: 'Jornales equipo obra - Junio 2024', amount: 1850000, taxAmount: 0, totalAmount: 1850000, status: ExpenseStatus.PAID, expenseDate: new Date('2024-06-30'), paidDate: new Date('2024-07-05'), projectId: project1.id, budgetId: budget1.id, categoryId: catManoObra.id, createdById: administrative.id, approvedById: pmMaria.id, approvedAt: new Date('2024-07-01') },
      { reference: 'GAS-2024-00006', description: 'Jornales equipo obra - Julio 2024', amount: 2200000, taxAmount: 0, totalAmount: 2200000, status: ExpenseStatus.PAID, expenseDate: new Date('2024-07-31'), paidDate: new Date('2024-08-05'), projectId: project1.id, budgetId: budget1.id, categoryId: catManoObra.id, createdById: administrative.id, approvedById: pmMaria.id, approvedAt: new Date('2024-08-01') },
      ...
      { reference: 'GAS-2024-00009', description: 'Alquiler de grúa torre - Agosto/Septiembre', amount: 2800000, taxAmount: 588000, totalAmount: 3388000, status: ExpenseStatus.PAID, expenseDate: new Date('2024-08-01'), paidDate: new Date('2024-09-01'), invoiceNumber: 'B-0010-00002345', invoiceType: 'B', projectId: project1.id, budgetId: budget1.id, categoryId: catEquipos.id, createdById: administrative.id, approvedById: pmMaria.id, approvedAt: new Date('2024-08-03') },
      ...
      { reference: 'GAS-2024-00011', description: 'Jornales equipo obra - Agosto 2024', amount: 2350000, taxAmount: 0, totalAmount: 2350000, status: ExpenseStatus.PAID, expenseDate: new Date('2024-08-31'), paidDate: new Date('2024-09-05'), projectId: project1.id, budgetId: budget1.id, categoryId: catManoObra.id, createdById: administrative.id, approvedById: pmMaria.id, approvedAt: new Date('2024-09-01') },
      { reference: 'GAS-2024-00012', description: 'Jornales equipo obra - Septiembre 2024', amount: 2450000, taxAmount: 0, totalAmount: 2450000, status: ExpenseStatus.PAID, expenseDate: new Date('2024-09-30'), paidDate: new Date('2024-10-05'), projectId: project1.id, budgetId: budget1.id, categoryId: catManoObra.id, createdById: administrative.id, approvedById: pmMaria.id, approvedAt: new Date('2024-10-01') },
      { reference: 'GAS-2024-00013', description: 'Seguro de obra - Póliza anual', amount: 1200000, taxAmount: 0, totalAmount: 1200000, status: ExpenseStatus.PAID, expenseDate: new Date('2024-06-01'), paidDate: new Date('2024-06-01'), projectId: project1.id, budgetId: budget1.id, categoryId: catAdmin.id, createdById: administrative.id, approvedById: pmMaria.id, approvedAt: new Date('2024-05-30') },
      ...
      { reference: 'GAS-2024-00015', description: 'Fletes y volquetes - Junio a Octubre', amount: 980000, taxAmount: 205800, totalAmount: 1185800, status: ExpenseStatus.PAID, expenseDate: new Date('2024-10-31'), paidDate: new Date('2024-11-15'), invoiceNumber: 'C-0008-00001234', invoiceType: 'C', projectId: project1.id, budgetId: budget1.id, categoryId: catTransporte.id, createdById: administrative.id, approvedById: pmMaria.id, approvedAt: new Date('2024-11-01') },
      // APPROVED (waiting payment)
      { reference: 'GAS-2024-00016', description: 'Jornales equipo obra - Octubre 2024', amount: 2600000, taxAmount: 0, totalAmount: 2600000, status: ExpenseStatus.APPROVED, expenseDate: new Date('2024-10-31'), dueDate: new Date('2024-11-10'), projectId: project1.id, budgetId: budget1.id, categoryId: catManoObra.id, createdById: administrative.id, approvedById: pmMaria.id, approvedAt: new Date('2024-11-02') },
      ...
      { reference: 'GAS-2025-00002', description: 'Jornales equipo obra - Noviembre 2024', amount: 2750000, taxAmount: 0, totalAmount: 2750000, status: ExpenseStatus.PENDING_APPROVAL, expenseDate: new Date('2024-11-30'), projectId: project1.id, budgetId: budget1.id, categoryId: catManoObra.id, createdById: administrative.id },
      ...
      { reference: 'GAS-2023-00007', description: 'Jornales equipo obra - Jun a Sep 2023', amount: 6800000, taxAmount: 0, totalAmount: 6800000, status: ExpenseStatus.PAID, expenseDate: new Date('2023-09-30'), paidDate: new Date('2023-10-05'), projectId: project4.id, budgetId: budget4.id, categoryId: catManoObra.id, createdById: administrative.id, approvedById: pmMaria.id, approvedAt: new Date('2023-10-01') },
      ...
      { reference: 'GAS-2023-00010', description: 'Jornales equipo obra - Oct a Dic 2023', amount: 7200000, taxAmount: 0, totalAmount: 7200000, status: ExpenseStatus.PAID, expenseDate: new Date('2023-12-31'), paidDate: new Date('2024-01-05'), projectId: project4.id, budgetId: budget4.id, categoryId: catManoObra.id, createdById: administrative.id, approvedById: pmMaria.id, approvedAt: new Date('2024-01-02') },
      { reference: 'GAS-2024-00022', description: 'Tirantería y cubierta de tejas', amount: 2200000, taxAmount: 462000, totalAmount: 2662000, status: ExpenseStatus.PAID, expenseDate: new Date('2023-11-18'), paidDate: new Date('2023-12-18'), invoiceNumber: 'B-0015-00001234', invoiceType: 'B', projectId: project4.id, budgetId: budget4.id, categoryId: catSubcontratos.id, createdById: administrative.id, approvedById: pmMaria.id, approvedAt: new Date('2023-11-20') },
      ...
      { reference: 'GAS-2024-00025', description: 'Jornales equipo obra - Ene a Abr 2024', amount: 8200000, taxAmount: 0, totalAmount: 8200000, status: ExpenseStatus.PAID, expenseDate: new Date('2024-04-15'), paidDate: new Date('2024-04-20'), projectId: project4.id, budgetId: budget4.id, categoryId: catManoObra.id, createdById: administrative.id, approvedById: pmMaria.id, approvedAt: new Date('2024-04-16') },
      ...
      { reference: 'GAS-2024-00028', description: 'Seguro de obra - Póliza anual', amount: 650000, taxAmount: 0, totalAmount: 650000, status: ExpenseStatus.PAID, expenseDate: new Date('2023-06-01'), paidDate: new Date('2023-06-01'), projectId: project4.id, budgetId: budget4.id, categoryId: catAdmin.id, createdById: administrative.id, approvedById: pmMaria.id, approvedAt: new Date('2023-05-30') },
      { reference: 'GAS-2024-00029', description: 'Alquiler equipos y herramientas varios', amount: 1400000, taxAmount: 294000, totalAmount: 1694000, status: ExpenseStatus.PAID, expenseDate: new Date('2023-12-15'), paidDate: new Date('2024-01-15'), invoiceNumber: 'C-0009-00002345', invoiceType: 'C', projectId: project4.id, budgetId: budget4.id, categoryId: catEquipos.id, createdById: administrative.id, approvedById: pmMaria.id, approvedAt: new Date('2023-12-17') },
      ...
      { reference: 'GAS-2024-00031', description: 'Vereda perimetral y parquización', amount: 950000, taxAmount: 199500, totalAmount: 1149500, status: ExpenseStatus.PAID, expenseDate: new Date('2024-04-03'), paidDate: new Date('2024-05-03'), invoiceNumber: 'C-0011-00001234', invoiceType: 'C', projectId: project4.id, budgetId: budget4.id, categoryId: catMateriales.id, createdById: administrative.id, approvedById: pmMaria.id, approvedAt: new Date('2024-04-05') },
    ],
  });
